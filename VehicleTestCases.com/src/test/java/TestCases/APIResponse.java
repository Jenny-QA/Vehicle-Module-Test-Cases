...
public class APIResponse {
	...
	public static final String subvehicleAdd = "Vehicle Type added successfully";
	public static final String subvehicleExists = "Vehicle Type already exists";
	public static final String subvehicleUpdate = "Vehicle Type updated successfully";
	public static final String subvehicleDelete = "Vehicle Type deleted successfully";
	public static final String subvehicleDeleteAlready = "Vehicle Type is already deleted";
	...
	public static final String pickupSuccess = "";
	public static final String pickupAdd = "";
	public static final String pickupExists = "";
	public static final String pickupUpdate = "";
	public static final String pickupDelete = "";
	public static final String pickupDeleteAlredy = "";
	
	//Promotion Master Messages
	public static final String promotionSuccess = "";
	public static final String promotionAdd = "";
	public static final String promotionExists = "";
	public static final String promotionUpdate = "";
	public static final String promotionDelete = "";
	public static final String promotionDeleteAlready = "";
	
	//Billing Type Messages
	public static final String billingSuccess = "";
	public static final String billingAdd = "";
	public static final String billingExists = "";
	public static final String billingUpdate = "";
	public static final String billingDelete = "";
	public static final String billingDeleteAlready = "";
	
	//Weight unit Messages
	public static final String unitSuccess = "";
	public static final String unitAdd = "";
	public static final String unitExists = "";
	public static final String unitUpdate = "";
